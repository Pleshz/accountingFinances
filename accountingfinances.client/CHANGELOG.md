...
- Create Angular project with ng: `ng new accountingfinances.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`accountingfinances.client.esproj`).
